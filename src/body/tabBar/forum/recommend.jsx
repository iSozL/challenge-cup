...
class RecommendPost extends React.Component {
  ...
  render() {
    const recommendPostData = [
      ...
      {
        title: "为什么呢？",
        subtitle: <div style={{fontSize: 18}}>为什么呢
                    <p style={{fontSize: 14,color: 'grey', marginTop: 15}}>浏览: 99 点赞: 999 讨论: 90</p>
                    <p style={{fontSize: 14,color: 'grey'}}>内容: 医学是以诊断、治疗和预防生理和心理疾病和提高人体自身素质为目的的应用科学。</p>
                  </div>
      },
      {
        title: "为什么呢？",
